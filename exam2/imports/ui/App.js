...
export default  class App extends Component{
  ...
  componentDidMount() {
    ...
    .then((responseJson) => {
      ...
      let selectedRoute = responseJson.route[this.state.route]
      let buses = []
  ...
  render(){
    ...
    <div >
      ...
      <input type = "text" className = "input" placeholder="Nickname" ref = "text"/>
        <button type="button" className="btn howTo-button" onClick={()=>{this.joinView(this.refs.text)}} >Enter</button>
    </div>
    )
  }
}
